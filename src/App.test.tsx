...
describe('practice flow', () => {
  it('moves from configuration through import, practice, review, and reset', async () => {
    ...
    expect(screen.getByRole('heading', { name: 'Bawa soal dari AI. Kerjakan seperti ujian.' })).toBeInTheDocument()
    ...
    fireEvent.click(screen.getByRole('button', { name: 'Buat instruksi untuk AI' }))
